 ...
 * <p>Authentication options provide the path, a {@link GcpCredentialSupplier},
 * role and JWT expiry for GCP IAM authentication. Instances of this class are
...
public class GcpIamAuthenticationOptions extends GcpIamAuthenticationSupport {
	...
	/**
	 * @return GCP project id accessor to obtain the project id of GCP IAM API
	 * calls.
	 * @since 2.1
	 */
	...
	public static class GcpIamAuthenticationOptionsBuilder {
		 ...
		 * configured, falls back to using
		...
		/**
		 * Configure an {@link GcpServiceAccountIdAccessor} to obtain the service
		...
		/**
		 * Configure an {@link GcpProjectIdAccessor} to use in GCP IAM API calls. If
		 * none is configured, falls back using
		 * {@link GoogleCredential#getServiceAccountProjectId()}.
