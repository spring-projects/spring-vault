...
class RestClientOperationsWrapper implements RestOperations {
	...
	public <T> ResponseEntity<T> exchange(RequestEntity<?> requestEntity, Class<T> responseType) throws RestClientException {
		return restClient.method(requestEntity.getMethod()).uri(requestEntity.getUrl())
				.body(requestEntity.getBody())
				.headers(it -> it.putAll(requestEntity.getHeaders())).retrieve()
				.toEntity(responseType);
	}
	...
	@Override
	public <T> @Nullable T execute(String uriTemplate, HttpMethod method, @Nullable RequestCallback requestCallback, @Nullable ResponseExtractor<T> responseExtractor, @Nullable Object... uriVariables) throws RestClientException {
		return null;
	}

	@Override
	public <T> @Nullable T execute(String uriTemplate, HttpMethod method, @Nullable RequestCallback requestCallback, @Nullable ResponseExtractor<T> responseExtractor, Map<String, ?> uriVariables) throws RestClientException {
		return null;
	}

	@Override
	public <T> @Nullable T execute(URI url, HttpMethod method, @Nullable RequestCallback requestCallback, @Nullable ResponseExtractor<T> responseExtractor) throws RestClientException {
		return null;
	}
}
