...
/**
 * Annotation to activate Vault repositories. If no base package is configured
...
public @interface EnableVaultRepositories {
	 ...
	 * annotation declarations e.g.: {@code @EnableVaultRepositories("org.my.pkg")}
	 * instead of {@code @EnableVaultRepositories(basePackages="org.my.pkg")}.
	 */
	...
	/**
	 * Return the postfix to be used when looking up custom repository
	...
	/**
	 * Return the key of the {@link QueryLookupStrategy} to be used for lookup
	 * queries for query methods. Defaults to {@link Key#CREATE_IF_NOT_FOUND}.
	 */
	Key queryLookupStrategy() default Key.CREATE_IF_NOT_FOUND;

	/**
	 * Return the {@link FactoryBean} class to be used for each repository
	 * instance. Defaults to {@link VaultRepositoryFactoryBean}.
	 */
	...
	/**
	 * Configures the name of the {@link KeyValueOperations} bean to be used with
	 ...
	 * {@link org.springframework.vault.core.VaultOperations} to be used. Defaulted
	 * to {@literal vaultTemplate}.
	 */
