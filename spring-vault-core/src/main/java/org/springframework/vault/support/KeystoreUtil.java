...
class KeystoreUtil {
   ...
   * @throws IOException
   */
  static KeyStore createKeyStore(String keyAlias, KeySpec privateKeySpec, String privateKeyType,
      X509Certificate... certificates) throws GeneralSecurityException, IOException {

    PrivateKey privateKey = KeyFactory.getInstance(privateKeyType).generatePrivate(privateKeySpec);
