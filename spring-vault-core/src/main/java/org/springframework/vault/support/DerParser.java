 ...
 * with an outer tag.
 * <p>
 * <p>This parser can only handle one layer. To parse nested constructs, get a
 * new parser for each layer using <code>Asn1Object.getParser()</code>.
 * <p>
 * <p>There are many DER decoders in JRE but using them will tie this program
 * to a specific JCE/JVM.
 *
 * @author Mark Paluch
 * @since 2.4
 */
...
class DerParser {
	...
	static class Asn1Object {
		 ...
		 * (Integer, String) or a construct (sequence, choice, set).</li>
		 * </ul>
