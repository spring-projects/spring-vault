 ...
 * <p>Flattening is particularly useful when representing a JSON object as
 * {@link java.util.Properties}
 * <p>{@link JsonMapFlattener} flattens {@link Map maps} containing nested
 * {@link java.util.List}, {@link Map} and simple values into a flat
 * representation. The hierarchical structure is reflected in properties using
 * dot-notation. Nested maps are considered as sub-documents.
 * <p>Input:
 *
 * <pre class="code">
...
public abstract class JsonMapFlattener {
	...
	/**
	 * Flatten a hierarchical {@link Map} into a flat {@link Map} with key names
	 * using property dot notation.
