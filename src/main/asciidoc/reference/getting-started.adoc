...
See https://docs.spring.io/spring-framework/docs/{springVersion}/javadoc-api/org/springframework/core/env/ConfigurableEnvironment.html[`ConfigurableEnvironment`] and
https://docs.spring.io/spring/docs/{springVersion}/javadoc-api/org/springframework/core/env/MutablePropertySources.html[`MutablePropertySources`] for details.
