...
Spring Vault 1.x binaries requires JDK level 6.0 and above, and https://spring.io/docs[Spring Framework] {springVersion} and above. While we maintain Java 6 compatibility, new projects should consider using Java 8  .
