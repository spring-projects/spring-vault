...
`RestClient`. Spring Web support provides the mapping infrastructure.
...
in {spring-framework-docs}/core/beans/factory-nature.html#beans-factory-lifecycle[lifecycle events]
