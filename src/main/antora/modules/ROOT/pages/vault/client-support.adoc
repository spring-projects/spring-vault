...
`VaultClient` is designed to be extensible and allows to plug in different HTTP clients based on a design similar to {spring-framework-docs}/integration/rest-clients.html#rest-resttemplate[`RestClient`].
