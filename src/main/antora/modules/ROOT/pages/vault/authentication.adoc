...
The javadoc:org.springframework.vault.authentication.ClientAuthentication[] interface enables authentication against Vault and returns a `VaultToken` for authenticated Vault requests.
